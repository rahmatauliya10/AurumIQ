...
> **Audit Timestamp:** `2026-09-08 06:36:07 UTC`  
...
| **Spread Distribution** | `base_spread_bps`, `stress_spread_bps` | `EMPIRICAL_SAMPLE_EVIDENCE_AVAILABLE` | Directive 6: Requires verified MT5 tick export ($N \ge 1000$, $\ge 5$ distinct dates, 4 sessions). |
