...
| **Phase 2** | [`docs/phases/PHASE_2_INDICATORS_REGIME_STRUCTURE.md`](./PHASE_2_INDICATORS_REGIME_STRUCTURE.md) | Pure Indicators, Causal Regimes, Swings, Sample Guard (Normalized HHI), Realized Vol ($ddof=0$) | ✅ **FROZEN (`ca6394bed2`)** |
| **Phase 3A** | [`docs/phases/PHASE_3A_ROBUST_TIME_CYCLE.md`](./PHASE_3A_ROBUST_TIME_CYCLE.md) | Session Cycle (DST-aware via zoneinfo), Swing Duration, Macro Event PiT Gate, Calendar Seasonality | ✅ **VERIFIED (84/84 Tests)** |
| **Phase 3B** | [`docs/phases/PHASE_3B_EXPERIMENTAL_TIME_CYCLE.md`](./PHASE_3B_EXPERIMENTAL_TIME_CYCLE.md) | Causal ACF, FFT, Wavelet CWT, Hilbert Phase, Multi-Criteria Promotion Gate | 📋 Next Scope |
